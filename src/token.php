...
// アクセストークンを使用してLINEユーザーのプロファイル情報を取得
$profileUrl = 'https://api.line.me/v2/profile';
$profileCh = curl_init($profileUrl);
curl_setopt($profileCh, CURLOPT_HTTPHEADER, array('Authorization: Bearer ' . $accessToken));
...
$lineUserId = $profileJson->userId; // LINEユーザーIDを取得
